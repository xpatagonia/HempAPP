...
export default function Locations() {
  ...
  const handleDelete = (id: string) => { if(window.confirm("¿Estás seguro de eliminar este sitio?")) deleteLocation(id); };
    ...
    <div className="animate-in fade-in duration-500">
      ...
      <div className="space-y-6">
        {visibleLocations.length === 0 && (
            <div className="text-center py-10 bg-gray-50 dark:bg-slate-900 rounded-lg border border-dashed border-gray-300 dark:border-slate-700 text-gray-500">No se encontraron campos.</div>
        )}
