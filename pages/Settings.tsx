...
BEGIN
    ...
    IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME='locations' AND COLUMN_NAME='soil_type') THEN ALTER TABLE public.locations ADD COLUMN soil_type TEXT; END IF;
