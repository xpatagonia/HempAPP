              ...
              <div className="bg-slate-900 border border-slate-800 p-8 rounded-[40px] shadow-2xl relative overflow-hidden">
                  ...
                  <div className="bg-amber-900/20 border border-amber-500/30 p-4 rounded-2xl mb-6 flex items-start text-amber-200">
                      ...
                      <div className="text-xs space-y-2 leading-relaxed">
                        ...
                        <p>Actualiza la estructura de establecimientos y campañas para soportar arreglos de responsables.</p>
                      </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    <button onClick={() => {
                      const sql = `
-- PROTOCOLO V26: ACTUALIZACIÓN DE ESTRUCTURA MAESTRA
...
-- PARCHE DE COLUMNAS (Aditivo)
DO $$ 
BEGIN
    -- Arreglos de responsables en localizaciones si no existen
    ...
    -- Arreglos de responsables en proyectos si no existen
    ...
    -- Campos extendidos de establecimientos
...
GRANT ALL ON ALL TABLES IN SCHEMA public TO anon, authenticated;
                      ...
                      alert("Script Nuclear V26 Copiado.");
